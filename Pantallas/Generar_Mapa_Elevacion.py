...
image_path = "/Users/gaby/Desktop/Software_Laptop/Pantallas/ojo_derechito.jpeg"  # Asegúrate de que esta imagen exista en la misma carpeta o especifica la ruta completa
...
if img_color is None:
    ...
    output_path = "mapa_elevacion_derecho.jpg"
    mapa_elevacion = cv2.imread(mapa_elevacion_path)
    cv2.imwrite(output_path, mapa_elevacion)

    print(f"El mapa de elevación ha sido guardado como {output_path}")
'''